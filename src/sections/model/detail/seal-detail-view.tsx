...
export default function SealDetailView({
  car,
  previousCar,
  nextCar,
}: ModelDetailProps) {
        ...
        <section className="relative h-[100vh] xs:h-[100vh] overflow-hidden">
          ...
          <div className="relative z-10 h-full flex justify-center px-6 sm:px-12 md:px-16">
            ...
            <motion.div
              ...
              className="absolute top-36 left-4 sm:left-24 lg:left-36"
            >
              <p className="text-4xl xs:text-5xl sm:text-6xl ml-1.5 tracking-[0.2em] text-white font-semibold uppercase mb-2">
                BYD SEAL
              </p>
            </motion.div>
