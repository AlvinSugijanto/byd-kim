...
export default function DenzaDetailView({
  car,
  previousCar,
  nextCar,
}: ModelDetailProps) {
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
        ...
        <section className="relative h-[100vh] xs:h-[100vh] overflow-hidden">
          ...
          <div className="absolute inset-0">
            <Image
              src={"/detail/denza/2.png"}
              alt={car.name}
              fill
              className="object-cover object-[20%_90%]"
              priority
            />
          ...
          <div className="relative z-10 h-full flex justify-center px-6 sm:px-12 md:px-16">
            ...
            <motion.div
              ...
              className="absolute top-24 right-4 sm:right-24 lg:right-36"
            >
              <h1 className="text-5xl md:text-6xl xl:text-6xl font-bold text-white leading-tight tracking-tight mb-2 font-mono">
                BYD {carNameClean}
              </h1>
            </motion.div>
        ...
        {car.title && (
          <section className="relative h-[100vh] px-4 py-8 xs:py-16 flex flex-col sm:gap-12 gap-8 overflow-hidden">
            ...
            <div className="absolute inset-0">
              <Image
                src="/detail/denza/1.png"
                alt="Background"
                fill
                className="object-cover xs:object-center object-[10%_50%]"
              />
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <p className="text-md md:text-xl text-white font-medium text-justify">
                  {car.description}
                </p>
              </motion.div>
            </div>
